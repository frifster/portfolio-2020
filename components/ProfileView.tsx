    ...
    return (
        ...
        >
            ...
            <div className={styles.greetingsContainer}>
                <p>
                    I am a <strong>Full Stack Developer</strong> specializing in React JS and React Native. I have six
                ...
                <p>
                    Leading a team of developers also has honed me to actively work with people, and business partners
                    in identifying the pain points of a project, while also implementing solutions that would work best
                    for them.
                </p>
                <p>
